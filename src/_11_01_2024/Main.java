...
public class Main {
    ...
    private static void mergeSort(int[] arr) {
        ...
        int[] rightArr = new int[lengthArr - mid]; // правы подмассив*
...
// контролируем индекс в основном массиве
        ...
        while (leftIndex < leftArrLength && rightIndex < rightArrLength) {
            if (leftArr[leftIndex] > rightArr[rightIndex]) { //сравниваем элемент в левом и правом подмассиве
                arr[arrIndex] = leftArr[leftIndex]; // если условие верно, то элемент в левом меньше, сохраняем его в0 ячейку основного массива
                leftIndex++;
                arrIndex++;
            } else {
